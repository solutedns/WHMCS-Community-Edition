...
$_ADDONLANG['global_validation_SOA_PART_INVALID'] = "SOA record part %d must be a valid numeric.";
...
$_ADDONLANG['global_validation_NAPTR_PART_INVALID'] = "Record part %d must be numeric.";
$_ADDONLANG['global_validation_NAPTR_PART_QUOTE_INVALID'] = "Record part %d must be quoted";
$_ADDONLANG['global_validation_NAPTR_PART_FLAGS_INVALID'] = "Record part %d contains invalid characters. This part may only contain alphanumeric characters.";
$_ADDONLANG['global_validation_NAPTR_PART_EX_FLAGS_INVALID'] = "Record part %d contains too many FLAGS (S, A, U). Only one can be used each time.";
$_ADDONLANG['global_validation_NAPTR_PART_QUOTE_INVALID'] = "Record part %d must be quoted.";
$_ADDONLANG['global_validation_NAPTR_PART_TERMINAL_FLAG_INVALID'] = "A SERVICE (record part %d) must be specified if the FLAGS including a terminal flag.";
$_ADDONLANG['global_validation_NAPTR_PART_SERVICE_INVALID'] = "SERVICE (record part %d) seems to be invalid.";
$_ADDONLANG['global_validation_NAPTR_PART_QUOTE_INVALID'] = "Record part %d must be quoted.";
$_ADDONLANG['global_validation_NAPTR_PART_DELIMITER_INVALID'] = "The POSIX replacement regexp (record part %d) is invalid. Delimiter may not be: ‘i’, �? or be a digit.";
$_ADDONLANG['global_validation_NAPTR_PART_REPLACEMENT_INVALID'] = "The POSIX replacement regexp (record part %d) is invalid. Not all required parts were specified.";
$_ADDONLANG['global_validation_NAPTR_PART_BACKREF_INVALID'] = "The POSIX replacement regexp (record part %d) is invalid. Only one back reference can be used, and should be like: ‘1’.";
$_ADDONLANG['global_validation_NAPTR_PART_FLAG_INVALID'] = "The POSIX regexp flag of (record part %d) is invalid. Optionally it may contain ‘i’, or nothing at all.";
$_ADDONLANG['global_validation_NAPTR_PART_EMPTY_INVALID'] = "Record part %d is invalid and must be a record pointer or single dot.";
$_ADDONLANG['global_validation_NAPTR_PART_SIM_INVALID'] = "REGEXP and REPLACEMENT variable (record part %d) cannot be used simoustaneously.";
$_ADDONLANG['global_validation_NAPTR_PART_REPLACEMENT_INVALID'] = "REPLACEMENT variable (record part %d) must be either ‘.’ or a valid domain.";
...
$_ADDONLANG['global_validation_SRV_PART_WEIGHT_INVALID'] = "Part %d (Weight) must be numeric.";
$_ADDONLANG['global_validation_SRV_PART_PORT_INVALID'] = "Part %d (Port) must be numeric.";
