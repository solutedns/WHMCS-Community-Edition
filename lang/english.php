...
$_ADDONLANG['global_validation_INVALID_FQHN'] = "A &lt;type&gt; record must contain a valid hostname, do not end with a dot (.).";
...
$_ADDONLANG['global_validation_SOA_PART_INVALID'] = "SOA record part &lt;int&gt; must be a valid numeric.";
$_ADDONLANG['global_validation_INVALID_NOT_QUOTED'] = "A &lt;type&gt; record must contain a quoted string.";
...
$_ADDONLANG['global_validation_NAPTR_PART_INVALID'] = "Record part &lt;int&gt; must be numeric.";
$_ADDONLANG['global_validation_NAPTR_PART_QUOTE_INVALID'] = "Record part &lt;int&gt; must be quoted.";
$_ADDONLANG['global_validation_NAPTR_PART_FLAGS_INVALID'] = "Record part &lt;int&gt; contains invalid characters. This part may only contain alphanumeric characters.";
$_ADDONLANG['global_validation_NAPTR_PART_EX_FLAGS_INVALID'] = "Record part &lt;int&gt; contains too many FLAGS (S, A, U). Only one can be used each time.";
$_ADDONLANG['global_validation_NAPTR_PART_TERMINAL_FLAG_INVALID'] = "A SERVICE (record part &lt;int&gt;) must be specified if the FLAGS including a terminal flag.";
$_ADDONLANG['global_validation_NAPTR_PART_SERVICE_INVALID'] = "SERVICE (record part &lt;int&gt;) seems to be invalid.";
$_ADDONLANG['global_validation_NAPTR_PART_DELIMITER_INVALID'] = "The POSIX replacement regexp (record part &lt;int&gt;) is invalid. Delimiter may not be: 'i', '' or be a digit.";
$_ADDONLANG['global_validation_NAPTR_PART_MISSING_INVALID'] = "The POSIX replacement regexp (record part &lt;int&gt;) is invalid. Not all required parts were specified.";
$_ADDONLANG['global_validation_NAPTR_PART_BACKREF_INVALID'] = "The POSIX replacement regexp (record part &lt;int&gt;) is invalid. Only one back reference can be used, and should be like: '1'.";
$_ADDONLANG['global_validation_NAPTR_PART_FLAG_INVALID'] = "The POSIX regexp flag of (record part &lt;int&gt;) is invalid. Optionally it may contain 'i', or nothing at all.";
$_ADDONLANG['global_validation_NAPTR_PART_EMPTY_INVALID'] = "Record part &lt;int&gt; is invalid and must be a record pointer or single dot.";
$_ADDONLANG['global_validation_NAPTR_PART_SIM_INVALID'] = "REGEXP and REPLACEMENT variable (record part &lt;int&gt;) cannot be used simoustaneously.";
$_ADDONLANG['global_validation_NAPTR_PART_REPLACEMENT_INVALID'] = "REPLACEMENT variable (record part &lt;int&gt;) must be either '.' or a valid domain.";
...
$_ADDONLANG['global_validation_SRV_PART_WEIGHT_INVALID'] = "Part &lt;int&gt; (Weight) must be numeric.";
$_ADDONLANG['global_validation_SRV_PART_PORT_INVALID'] = "Part &lt;int&gt; (Port) must be numeric.";
